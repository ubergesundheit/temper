...
h=a[b+"Hours"](),j=a[b+"Minutes"](),m=a[b+"Seconds"](),n=a[b+"Milliseconds"](),p=c?0:a.getTimezoneOffset();return b=d.replace(da,function(b){if("D"===b)return e;if("DD"===b)return z(e,2);if("DDD"===b)return $[f].slice(0,3);if("DDDD"===b)return $[f];if("M"===b)return g+1;if("MM"===b)return z(g+1,2);if("MMM"===b)return aa[g].slice(0,3);if("MMMM"===b)return aa[g];if("Y"===b)return parseInt(String(k).slice(-2));if("YY"===b)return z(String(k).slice(-2),2);if("YYY"===b)return z(String(k).slice(-3),3);if("YYYY"===
b)return z(k,4);if("h"===b)return h%12||12;if("hh"===b)return z(h%12||12,2);if("H"===b)return h;if("HH"===b)return z(h,2);if("m"===b)return j;if("mm"===b)return z(j,2);if("s"===b)return m;if("ss"===b)return z(m,2);if("f"===b)return String(n).slice(0,1);if("ff"===b)return z(String(n).slice(0,2),2);if("fff"===b)return z(String(n).slice(0,3),3);if("t"===b)return 12>h?"a":"p";if("tt"===b)return 12>h?"am":"pm";if("T"===b)return 12>h?"A":"P";if("TT"===b)return 12>h?"AM":"PM";if("K"===b)return c?"UTC":(String(a).match(ea)||
[""]).pop().replace(fa,"");if("z"===b)return(0<p?"-":"+")+Math.floor(Math.abs(p)/60);if("zz"===b)return(0<p?"-":"+")+z(Math.floor(Math.abs(p)/60),2);if("zzz"===b)return(0<p?"-":"+")+z(Math.floor(Math.abs(p)/60),2)+z(Math.abs(p)%60,2)})};var W=function(a,d){a=Number(a);var b=0>a?!0:!1;b&&(a*=-1);var c="";d=String(d);for(var e=1,f="",g="",k=-1,h=[],j=[],m=0,n=0,p=0,e=1,l=!1,s=0,g=d.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g),q=0;g&&q<g.length;q++)if(c=g[q],"."===c&&0>k)k=q;else{if("%"===
...
2,a.stroke(),a.fill());a.restore()};t.prototype.renderPie=function(a){function d(){w.ctx.save();w._eventManager.ghostCtx.save();w.ctx.translate(t.x,t.y);w._eventManager.ghostCtx.translate(t.x,t.y);w.ctx.fillStyle="#FFFFFF";w.ctx.fillRect(-v.width/2,-v.height/2,v.width,v.height);var a=!0===w.animationEnabled?60:1;if(null!=A&&A.frame<a){A.isAnimating--;for(var c=0,c=h[0],k=A.maxAngle+2*Math.PI/a,j=0;j<u;j++){var m=f.dataPoints[j].exploded,l=f.dataPoints[j].color?f.dataPoints[j].color:f.color?f.color:
y[j%y.length],q=c,r=c=q+2*Math.PI/n*Math.abs(f.dataPoints[j].y),s=!1;r>k&&(r=k,s=!0);type=f.type;"outside"===f.indexLabelPlacement?(indexLineMinLength=Math.min(v.width,v.height)/14,p=indexLineMinLength<x?x-indexLineMinLength:x-25):"inside"===f.indexLabelPlacement&&(p=(1-g)*0.5*Math.min(v.width,v.height));var z={x:0,y:0};K(w.ctx,z,p,l,type,q,r);q=!0===f.dataPoints[j].exploded?!0:!1;typeof f.dataPoints[j]===Boolean&&(userSetExploed=!0);r=f.dataPointIds[j];w._eventManager.objectMap[r]={objectType:"dataPoint",
dataSeriesIndex:0,dataPointIndex:j,center:{x:t.x,y:t.y},radius:p,color:l,startAngle:h[j],endAngle:h[j+1],currentlyExploded:q,userSetExploded:m,pastExploded:!1};m=S(r);w._eventManager.ghostCtx.save();l="rgb("+m[0]+","+m[1]+","+m[2]+")";K(w._eventManager.ghostCtx,z,p,l,type,h[j],h[j+1]);w._eventManager.ghostCtx.restore();if(s)break}A.maxAngle=k;A.frame++;A.frame<a?w.requestAnimFrame.call(window,d):(e(0,a),w.ctx.restore(),w._eventManager.ghostCtx.restore(),setTimeout(function(){A.frame=0;A.isAnimating=
20;b()},200))}w.renderCount++;w.ctx.restore();w._eventManager.ghostCtx.restore()}function b(){w.ctx.save();w._eventManager.ghostCtx.save();w.ctx.translate(t.x,t.y);w._eventManager.ghostCtx.translate(t.x,t.y);if(null!==A&&20>A.frame){A.isAnimating--;w.ctx.fillStyle="#FFFFFF";w.ctx.fillRect(-v.width/2,-v.height/2,v.width,v.height);for(var a=0;a<u;a++){var c=f.dataPoints[a].color?f.dataPoints[a].color:f.color?f.color:y[a%y.length],d={x:0,y:0},k=p*g*Math.cos(j[a]),m=p*g*Math.sin(j[a]),l=f.type,n=f.dataPointIds[a],
q=w._eventManager.objectMap[n].currentlyExploded,r=w._eventManager.objectMap[n].pastExploded;!0===q&&!1===r?(d.x+=k/20*(A.frame+1),d.y+=m/20*(A.frame+1),20===A.frame+1&&(w._eventManager.objectMap[n].pastExploded=!0)):!0===q&&!0===r&&(d.x+=k,d.y+=m);w._eventManager.objectMap[n].center.x=d.x+t.x;w._eventManager.objectMap[n].center.y=d.y+t.y;r!==q&&(k={},k.dataSeries=f,k.dataPoint=f.dataPoints[a],k.index=a,w._toolTip.highlightObjects([k]));K(w.ctx,d,p,c,l,h[a],h[a+1]);19===A.frame&&(n=f.dataPointIds[a],
c=S(n),w._eventManager.ghostCtx.save(),c="rgb("+c[0]+","+c[1]+","+c[2]+")",K(w._eventManager.ghostCtx,d,p,c,l,h[a],h[a+1]),w._eventManager.ghostCtx.restore())}A.frame++;20>A.frame&&w.requestAnimFrame.call(window,b)}e(A.frame,20);w.ctx.restore();w._eventManager.ghostCtx.restore()}function c(){w.ctx.save();w._eventManager.ghostCtx.save();w.ctx.translate(t.x,t.y);w._eventManager.ghostCtx.translate(t.x,t.y);if(null!==A&&0<A.frame){A.isAnimating--;w.ctx.fillStyle="#FFFFFF";w.ctx.fillRect(-v.width/2,-v.height/
2,v.width,v.height);for(var a=0;a<u;a++){var b=f.dataPointIds[a],d=w._eventManager.objectMap[b].currentlyExploded,k=w._eventManager.objectMap[b].pastExploded,m=f.dataPoints[a].color?f.dataPoints[a].color:f.color?f.color:y[a%y.length],l={x:0,y:0},n=f.type,d=w._eventManager.objectMap[b].currentlyExploded,q=p*g*Math.cos(j[a]),r=p*g*Math.sin(j[a]);!1===d&&!0===k?(l.x+=q/20*A.frame,l.y+=r/20*A.frame,1===A.frame&&(w._eventManager.objectMap[b].pastExploded=!1)):!0===d&&!0===k&&(l.x+=q,l.y+=r);w._eventManager.objectMap[b].center.x=
l.x+t.x;w._eventManager.objectMap[b].center.y=l.y+t.y;k!==d&&(b={},b.dataSeries=f,b.dataPoint=f.dataPoints[a],b.index=a,w._toolTip.highlightObjects([b]));K(w.ctx,l,p,m,n,h[a],h[a+1]);1===A.frame&&(b=f.dataPointIds[a],m=S(b),w._eventManager.ghostCtx.save(),m="rgb("+m[0]+","+m[1]+","+m[2]+")",K(w._eventManager.ghostCtx,l,p,m,n,h[a],h[a+1]),w._eventManager.ghostCtx.restore())}A.frame--;0<A.frame&&w.requestAnimFrame.call(window,c)}e(A.frame,20);w.ctx.restore();w._eventManager.ghostCtx.restore()}function e(a,
b){for(var c=0;c<f.dataPoints.length;c++){var d=f.dataPointIds[c],e=w.ctx,h=l[c],n=s[c],t=q[c],u=r[c],v=w._eventManager.objectMap[d].currentlyExploded,x=m[c],y=p,z=j[c],A=f.dataPoints[c].indexLabelFontColor?f.dataPoints[c].indexLabelFontColor:f.indexLabelFontColor,B=f.indexLabelPlacement,C=f.dataPoints[c].indexLabelLineColor?f.dataPoints[c].indexLabelLineColor:f.indexLabelLineColor,D=f.dataPoints[c].indexLabelLineThickness?f.dataPoints[c].indexLabelLineThickness:f.indexLabelLineThickness,E=a,F=b,
d=w._eventManager.objectMap[d].pastExploded,G=k[c],H=f.dataPoints[c].indexLabelFontStyle?f.dataPoints[c].indexLabelFontStyle:f.indexLabelFontStyle,I=f.dataPoints[c].indexLabelFontWeight?f.dataPoints[c].indexLabelFontWeight:f.indexLabelFontWeight,J=f.dataPoints[c].indexLabelFontSize?f.dataPoints[c].indexLabelFontSize:f.indexLabelFontSize,K=f.dataPoints[c].indexLabelFontFamily?f.dataPoints[c].indexLabelFontFamily:f.indexLabelFontFamily,L=f.dataPoints[c].indexLabelBackgroundColor?f.dataPoints[c].indexLabelBackgroundColor:
f.indexLabelBackgroundColor?f.indexLabelBackgroundColor:null,M=c;e.save();e.lineWidth=D;e.font=H+" "+I+" "+J+"px "+K;D="left";0>h&&"outside"===B?D="right":0<=h&&"outside"===B?D="left":"inside"===B&&(D="center");e.textAlign=D;e.textBaseline="middle";e.beginPath();L&&(e.fillStyle=L,"outside"===B?0<=h?e.fillRect(h-2.5,t-2.5,n-h+5,u-t+5):e.fillRect(h+2.5,t-2.5,n-h-5,u-t+5):"inside"===B&&(0<=h?e.fillRect(h-G/2-2.5,t-2.5,n-h+5,u-t+5):e.fillRect(h+G/2+2.5,t-2.5,n-h-5,u-t+5)));e.fillStyle=A;e.fillText(x,
h,(t+u)/2);"outside"===B&&k[M]&&(n=y*Math.cos(z),x=y*Math.sin(z),!0===v&&!0!==d?(n+=y*g*Math.cos(z)/F*E,x+=y*g*Math.sin(z)/F*E):!0===v&&!0===d?(n+=y*g*Math.cos(z),x+=y*g*Math.sin(z)):!0!==v&&!0===d&&(n+=y*g*Math.cos(z)/F*E,x+=y*g*Math.sin(z)/F*E),e.moveTo(n,x),0<h?(e.lineTo(h-10,(t+u)/2),e.lineTo(h-2,(t+u)/2)):0>h&&(e.lineTo(h+10,(t+u)/2),e.lineTo(h+2,(t+u)/2)),e.strokeStyle=C,e.stroke());e.restore()}}if(!(0>=a.dataSeriesIndexes.length)){var f=this.data[a.dataSeriesIndexes[0]],g=0.07;ctx=this.ctx;
var k=[],h=[],j=[],m=[],n=0,p=0,l=[],s=[],q=[],r=[],u=f.dataPoints.length,v=this.getPlotArea();v.width=v.x2-v.x1;v.height=v.y2-v.y1;var t={x:(v.x2+v.x1)/2,y:(v.y2+v.y1)/2};a=f.startAngle?f.startAngle:0;a=(a%360+360)%360*Math.PI/180;h.push(a);var y=this.colorSet,x=0.5*Math.min(v.width,v.height);for(a=0;a<u;a++){var z=f.dataPoints[a].indexLabel?f.dataPoints[a].indexLabel:f.indexLabel?f.indexLabel:f.dataPoints[a].label?f.dataPoints[a].label:f.label?f.label:"",z=this.replaceKeywordsWithValue(z,f.dataPoints[a],
f,a);m.push(z);z=ctx.measureText(m[a]).width;k.push(z);n+=Math.abs(f.dataPoints[a].y)}for(a=z=0;a<u;a++){var B;B=Math.abs(f.dataPoints[a].y);B=2*Math.PI*(B/n);h.push(h[a]+B);B=B/2+h[a];j.push(B%(2*Math.PI));z+=k[a]}0===z&&(f.indexLabelPlacement="inside");z=0;if("inside"===f.indexLabelPlacement){x*=0.8*(1-g);for(a=0;a<u;a++){var D=x*Math.cos(j[a]),C=x*Math.sin(j[a]);l.push(D);0<D?s.push(l[a]+k[a]):s.push(l[a]-k[a]);q.push(C-f.indexLabelFontSize/2);r.push(C+f.indexLabelFontSize/2)}}else if("outside"===
f.indexLabelPlacement)for(B=0;3>B;B++){for(a=0;a<u;a++)D=x*Math.cos(j[a]),C=x*Math.sin(j[a]),l.push(D),0<D?s.push(l[a]+k[a]):s.push(l[a]-k[a]),q.push(C-f.indexLabelFontSize/2),r.push(C+f.indexLabelFontSize/2);for(a=0;a<u;a++)j[a]<Math.PI/2&&(1<=a&&q[a]<r[a-1])&&(D=r[a-1]-q[a],q[a]+=D+2,r[a]+=D+2,20>u&&(q[a]+=3,r[a]+=3)),j[a]<3*Math.PI/2&&j[a]>=Math.PI&&r[a]>q[a-1]&&(D=r[a]-q[a-1],q[a]-=D+2,r[a]-=D+2,20>u&&(q[a]-=3,r[a]-=3));for(a=u;0<=a;a--)j[a]<Math.PI&&j[a]>=Math.PI/2&&q[a]<r[a+1]&&(D=r[a+1]-q[a],
q[a]+=D+2,r[a]+=D+2,20>u&&(q[a]+=3,r[a]+=3)),j[a]>=3*Math.PI/2&&r[a]>q[a+1]&&(D=r[a]-q[a+1],q[a]-=D,r[a]-=D,20>u&&(q[a]+=-3,r[a]+=-3));if(2>z){a=Math.min.apply(Math,q.concat(r));var D=Math.max.apply(Math,q.concat(r)),C=Math.max.apply(Math,s.concat(l)),F=Math.min.apply(Math,s.concat(l)),E=[];Math.abs(a)>v.height/2&&E.push(Math.abs(a)-v.height/2);Math.abs(D)>v.height/2&&E.push(Math.abs(D)-v.height/2);Math.abs(C)>v.width/2&&E.push(Math.abs(C)-v.width/2);Math.abs(F)>v.width/2&&E.push(Math.abs(F)-v.width/
2);l=[];s=[];q=[];r=[];E.length&&(x-=Math.max.apply(Math,E)+f.indexLabelFontSize/2+2,40>x&&(x=40));z++}}var w=this,A={frame:0,maxAngle:h[0],count:0};0!==w.renderCount&&(this.animationEnabled=!1);A.isAnimating=60;d();this.pieDoughnutClickHandler=function(a){if(0===A.isAnimating){a=a.dataPointIndex;var d=f.dataPointIds[a];!0===w._eventManager.objectMap[d].currentlyExploded?(!0===w._eventManager.objectMap[d].userSetExploded&&(f.dataPoints[a].exploded=!1),w._eventManager.objectMap[d].currentlyExploded=
!1,A.frame=20,A.isAnimating=20,c()):!1===w._eventManager.objectMap[d].currentlyExploded&&(!0===w._eventManager.objectMap[d].userSetExploded&&(f.dataPoints[a].exploded=!0),w._eventManager.objectMap[d].currentlyExploded=!0,A.isAnimating=20,A.frame=0,b())}}}};t.prototype.requestAnimFrame=window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||function(a){window.setTimeout(a,1E3/60)};N.prototype.registerSpace=
function(a,d){"top"===a?this._topOccupied+=d.height:"bottom"===a?this._bottomOccupied+=d.height:"left"===a?this._leftOccupied+=d.width:"right"===a&&(this._rightOccupied+=d.width)};N.prototype.unRegisterSpace=function(a,d){"top"===a?this._topOccupied-=d.height:"bottom"===a?this._bottomOccupied-=d.height:"left"===a?this._leftOccupied-=d.width:"right"===a&&(this._rightOccupied-=d.width)};N.prototype.getFreeSpace=function(){return{x1:this._leftOccupied,y1:this._topOccupied,x2:this.canvas.width-this._rightOccupied,
y2:this.canvas.height-this._bottomOccupied,width:this.canvas.width-this._rightOccupied-this._leftOccupied,height:this.canvas.height-this._bottomOccupied-this._topOccupied}};N.prototype.reset=function(){this._rightOccupied=this._leftOccupied=this._bottomOccupied=this._topOccupied=0};J(C,E);C.prototype.render=function(a){a&&this.ctx.save();var d=this.ctx.font;this.ctx.textBaseline=this.textBaseline;this._isDirty&&this.measureText(this.ctx);this.ctx.translate(this.x,this.y);this.ctx.font=this._getFontString();
this.ctx.rotate(Math.PI/180*this.angle);var b=0,c=this.padding,e=null;if(0<this.borderThickness&&this.borderColor||this.backgroundColor)this.ctx.roundRect(0,0,this.width,this.height,this.cornerRadius,this.borderThickness,this.backgroundColor,this.borderColor),"middle"===this.textBaseline&&(c+=this.fontSize/2);this.ctx.fillStyle=this.fontColor;for(var f=0;f<this._wrappedText.lines.length;f++)e=this._wrappedText.lines[f],"right"===this.horizontalAlign?b=this.width-e.width-this.padding:"left"===this.horizontalAlign?
b=this.padding:"center"===this.horizontalAlign&&(b=(this.width-2*this.padding)/2-e.width/2+this.padding),this.ctx.fillText(e.text,b,c),c+=e.height;this.ctx.font=d;a&&this.ctx.restore()};C.prototype.setText=function(a){this.text=a;this._isDirty=!0;this._wrappedText=null};C.prototype.measureText=function(){if(null===this.maxWidth)throw"Please set maxWidth and height for TextBlock";this._wrapText(this.ctx);this._isDirty=!1;return{width:this.width,height:this.height}};C.prototype._wrapText=function(){text=
new String(M(this.text));var a=[],d=this.ctx.font,b=0,c=0;for(this.ctx.font=this._getFontString();0<text.length;){for(var e=text,f=0,g=0,k=this.maxWidth-2*this.padding,h=this.maxHeight-2*this.padding;;)if(f=this.ctx.measureText(e).width,g=0,f>k)g=e.length/f*k,f=Math.max(Math.min(Math.ceil(g),e.length-1),0),g=e.lastIndexOf(" ",f,e.length-1),e=0<=g?M(text.slice(0,g)):M(text.slice(0,f-1));else{a.push({text:e,width:f,height:this.fontSize});c=Math.max(c,f);b+=this.fontSize;text=M(text.slice(e.length,text.length));
break}if(h&&b>h-this.fontSize&&0<text.length){e=a.pop();Math.min(e.text.length,3);a.push(e);break}}this._wrappedText={lines:a,width:c,height:b};this.width=c+2*this.padding;this.height=b+2*this.padding;this.ctx.font=d};C.prototype._getFontString=function(){return this.fontStyle+" "+this.fontWeight+" "+this.fontSize+"px "+this.fontFamily};J(Q,E);Q.prototype.render=function(){if(this.text){var a=this.chart.layoutManager.getFreeSpace(),d=0,b=0,c=0,e=0,f=0,g,k;"top"===this.verticalAlign||"bottom"===this.verticalAlign?
(e=a.width-2*this.margin,f=0.5*a.height-2*this.margin,c=0):"center"===this.verticalAlign&&("left"===this.horizontalAlign||"right"===this.horizontalAlign?(e=a.height-2*this.margin,f=0.5*a.width-2*this.margin):"center"===this.horizontalAlign&&(e=a.width-2*this.margin,f=0.5*a.height-2*this.margin));var f=new C(this.ctx,{fontSize:this.fontSize,fontFamily:this.fontFamily,fontColor:this.fontColor,fontStyle:this.fontStyle,fontWeight:this.fontWeight,horizontalAlign:this.horizontalAlign,verticalAlign:this.verticalAlign,
...
this.margin:"center"===this.horizontalAlign?d=a.x1+(e/2-h.width/2)+this.margin:"right"===this.horizontalAlign&&(d=a.x2-this.margin-h.width),g=this.horizontalAlign,this.width=h.width,this.height=h.height):"center"===this.verticalAlign&&("left"===this.horizontalAlign?(d=a.x1+this.margin,b=a.y2-this.margin-(e/2-h.width/2),c=-90,k="left",this.width=h.height,this.height=h.width):"right"===this.horizontalAlign?(d=a.x2-this.margin,b=a.y1+this.margin+(e/2-h.width/2),c=90,k="right",this.width=h.height,this.height=
h.width):"center"===this.horizontalAlign&&(b=a.y1+(a.height/2-h.height/2),d=a.x1+(a.width/2-h.width/2),k="center",this.width=h.width,this.height=h.height),g="center");f.x=d;f.y=b;f.angle=c;f.horizontalAlign=g;f.render(!0);this.chart.layoutManager.registerSpace(k,{width:this.width+2*this.margin,height:this.height+2*this.margin});this.bounds={x1:d,y1:b,x2:d+this.width,y2:b+this.height};this.ctx.textBaseline="top"}};J(R,E);R.prototype.render=function(){var a=this.chart.layoutManager.getFreeSpace(),d=
null,b=0,c=0,e=0,f=0,g=[],k=[];"top"===this.verticalAlign||"bottom"===this.verticalAlign?(this.orientation="horizontal",d=this.verticalAlign,e=0.9*a.width,f=0.5*a.height):"center"===this.verticalAlign&&(this.orientation="vertical",d=this.horizontalAlign,e=0.5*a.width,f=0.9*a.height);for(var h=0;h<this.dataSeries.length;h++){var j=this.dataSeries[h],m=j.legendMarkerType?j.legendMarkerType:("line"===j.type||"scatter"===j.type||"bubble"===j.type)&&j.markerType?j.markerType:I.getDefaultLegendMarker(j.type),
n=j.legendText?j.legendText:j.name,p=j.legendMarkerColor?j.legendMarkerColor:j.markerColor?j.markerColor:j._colorSet[0],l=!j.markerSize&&"line"===j.type?0:0.7*this.fontSize;if("pie"!==j.type&&"doughnut"!==j.type)m={markerType:m,markerColor:p,text:n,textBlock:null,chartType:j.type,markerSize:l,lineColor:j._colorSet[0]},g.push(m);else for(var s=0;s<j.dataPoints.length;s++)l=j.dataPoints[s],m=l.legendMarkerType?l.legendMarkerType:j.legendMarkerType?j.legendMarkerType:I.getDefaultLegendMarker(j.type),
n=l.legendText?l.legendText:j.legendText?j.legendText:l.name?l.name:"DataPoint: "+(s+1),p=l.markerColor?l.markerColor:j.markerColor?j.markerColor:l.color?l.color:j.color?j.color:j._colorSet[s],l=(0===l.markerSize||0===j.markerSize&&!l.markerSize)&&"line"===j.type?0:0.7*this.fontSize,m={markerType:m,markerColor:p,text:n,textBlock:null,chartType:j.type,markerSize:l},g.push(m)}if(0<g.length){j=null;for(h=s=0;h<g.length;h++){m=g[h];if("horizontal"===this.orientation){if(m.textBlock=new C(this.ctx,{x:0,
y:0,maxWidth:e,maxHeight:this.fontSize,angle:0,text:m.text,horizontalAlign:"left",fontSize:this.fontSize,fontFamily:this.fontFamily,fontWeight:this.fontWeight,fontColor:this.fontColor,fontStyle:this.fontStyle,textBaseline:"top"}),m.textBlock.measureText(),!j||j.width+m.textBlock.width+(0===j.width?0:this.horizontalSpacing)>e)j={entries:[],width:0},k.push(j),this.height=k.length*(this.fontSize+5)}else this.height+this.fontSize<f?(j={entries:[],width:0},k.push(j),this.height=k.length*this.fontSize):
(j=k[s],s=(s+1)%k.length),m.textBlock=new C(this.ctx,{x:0,y:0,maxWidth:e,maxHeight:this.fontSize,angle:0,text:m.text,horizontalAlign:"left",fontSize:this.fontSize,fontFamily:this.fontFamily,fontWeight:this.fontWeight,fontColor:this.fontColor,fontStyle:this.fontStyle,textBaseline:"top"}),m.textBlock.measureText();m.textBlock.x=j.width+(0===j.width?0:this.horizontalSpacing);m.textBlock.y=0;j.width+=m.textBlock.width+(this.fontSize+5)+(0===j.width?0:this.horizontalSpacing);j.entries.push(m);this.width=
Math.max(j.width,this.width)}this.height=k.length*this.fontSize}"top"===this.verticalAlign?(c="left"===this.horizontalAlign?a.x1:"right"===this.horizontalAlign?a.x2-this.width:a.x1+a.width/2-this.width/2,b=a.y1):"center"===this.verticalAlign?(c="left"===this.horizontalAlign?a.x1:"right"===this.horizontalAlign?a.x2-this.width:a.x1+a.width/2-this.width/2,b=a.y1+a.height/2-this.height/2):"bottom"===this.verticalAlign&&(c="left"===this.horizontalAlign?a.x1:"right"===this.horizontalAlign?a.x2-this.width:
a.x1+a.width/2-this.width/2,b=a.y2-this.height-5);for(h=0;h<k.length;h++){var j=k[h],q;for(q in j.entries)m=j.entries[q],a=m.textBlock.x+c,e=b+h*this.fontSize,"line"===m.chartType&&(this.ctx.strokeStyle=m.lineColor,this.ctx.lineWidth=Math.ceil(this.fontSize/8),this.ctx.beginPath(),this.ctx.moveTo(a-2,e+this.fontSize/2),this.ctx.lineTo(a+2+this.fontSize,e+this.fontSize/2),this.ctx.stroke()),G.drawMarker(a+this.fontSize/2,e+this.fontSize/2,this.ctx,m.markerType,l,m.markerColor,null,0),m.textBlock.x=
a+this.fontSize+5,m.textBlock.y=e,m.textBlock.render(!0)}this.chart.layoutManager.registerSpace(d,{width:this.width,height:this.height+5+5});this.bounds={x1:c,y1:b,x2:c+this.width,y2:b+this.height}};J(U,E);U.prototype.render=function(){var a=this.chart.layoutManager.getFreeSpace();this.ctx.fillStyle="red";this.ctx.fillRect(a.x1,a.y1,a.x2,a.y2)};J(I,E);I.prototype.getDefaultAxisPlacement=function(){type=this.type.toLowerCase();if("column"===type||"line"===type||"area"===type||"stackedcolumn"===type||
"stackedline"===type||"bubble"===type||"scatter"===type||"stackedarea"===type||"stackedcolumn100"===type||"stackedline100"===type||"stackedarea100"===type)return"normal";if("bar"===type||"stackedbar"===type||"stackedbar100"===type)return"xySwapped";if("pie"===type||"doughnut"===type)return"none";window.console.log("Unknown Chart Type: "+type);return null};I.getDefaultLegendMarker=function(a){a=a.toLowerCase();if("column"===a||"stackedcolumn"===a||"stackedline"===a||"bar"===a||"stackedbar"===a||"stackedbar100"===
a||"bubble"===a||"scatter"===a||"stackedcolumn100"===a||"stackedline100"===a)return"square";if("line"===a||"pie"===a||"doughnut"===a)return"circle";if("area"===a||"stackedarea"===a||"stackedarea100"===a)return"triangle";window.console.log("Unknown Chart Type: "+a);return null};I.prototype.findDataPointByX=function(a,d){for(var b=0,c=this.dataPoints.length,e,f={dataPoint:null,distance:Infinity,index:NaN},g=0,k=null;b<c;){g++;e=(b+c)/2<<0;var k=this.dataPoints[e],h=Math.abs(k.x-a);h<f.distance&&(f.dataPoint=
k,f.distance=h,f.index=e);if(k.x<a)b=e+1;else if(k.x>a)c=e;else{f.dataPoint=k;f.distance=h;f.index=e;break}}return!d&&f.dataPoint.x===a?f:d&&null!==f.dataPoint?f:null};I.prototype.getMarkerProperties=function(a,d,b,c){var e=this.dataPoints,f=e[a].markerColor?e[a].markerColor:this.markerColor?this.markerColor:e[a].color?e[a].color:this.color?this.color:this._colorSet[a%this._colorSet.length];return{x:d,y:b,ctx:c,type:e[a].markerType?e[a].markerType:this.markerType,size:e[a].markerSize?e[a].markerSize:
this.markerSize,color:f,borderColor:e[a].markerBorderColor?e[a].markerBorderColor:this.markerBorderColor?this.markerBorderColor:f,borderThickness:e[a].markerBorderThickness?e[a].markerBorderThickness:this.markerBorderThickness?this.markerBorderThickness:1}};J(x,E);x.prototype.createLabels=function(){var a,d=0,b,c;if("axisX"===this.type&&"dateTime"===this.chart.plotInfo.axisXValueType){b=X(new Date(this.maximum),this.interval,this.intervalType);c=V;for(d=this.intervalStartPosition;d<b;X(d,this.interval,
this.intervalType))a="axisX"===this.type&&this.labels[d]?this.labels[d]:c(d,this.valueFormatString),a=new C(this.ctx,{x:0,y:0,maxWidth:this.maxHeight,maxHeight:this.labelFontSize,angle:this.labelAngle,text:this.prefix+a+this.suffix,horizontalAlign:"left",fontSize:this.labelFontSize,fontFamily:this.labelFontFamily,fontWeight:this.labelFontWeight,fontColor:this.labelFontColor,fontStyle:this.labelFontStyle,textBaseline:"middle"}),this._labels.push({position:d.getTime(),textBlock:a,effectiveHeight:null})}else{b=
this.maximum;c=W;if(Math.floor(this.interval)<this.interval&&!this._options.interval){a=Math.ceil(this.interval);for(var e=Math.ceil(this.intervalStartPosition),f=!1,d=e;d<=this.maximum;d+=a)if(this.labels[d])f=!0;else{f=!1;break}f&&(this.interval=a,this.intervalStartPosition=e)}for(d=this.intervalStartPosition;d<=b;d+=this.interval)a="axisX"===this.type&&this.labels[d]?this.labels[d]:c(d,this.valueFormatString),a=new C(this.ctx,{x:0,y:0,maxWidth:this.maxHeight,maxHeight:this.labelFontSize,angle:this.labelAngle,
...
new C(this.ctx,{x:this.boundingRect.x2-5,y:this.lineCoordinates.y2,maxWidth:this.lineCoordinates.height,maxHeight:this.titleFontSize,angle:90,text:this.title,horizontalAlign:"center",fontSize:this.titleFontSize,fontFamily:this.titleFontFamily,fontWeight:this.titleFontWeight,fontColor:this.titleFontColor,fontStyle:this.titleFontStyle,textBaseline:"top"}),this._titleTextBlock.measureText(),this._titleTextBlock.y=this.lineCoordinates.height/2-this._titleTextBlock.width/2+this.lineCoordinates.y1,this._titleTextBlock.render(!0))}};
x.prototype.renderInterlacedColors=function(){var a,d,b=this.chart.getPlotArea();if(("bottom"===this._position||"top"===this._position)&&this.interlacedColor){var c=0;this.ctx.fillStyle=this.interlacedColor;for(c=0;c<this._labels.length;c+=2)a=this.getPixelCoordinatesOnAxis(this._labels[c].position),d=c+1>=this._labels.length?this.getPixelCoordinatesOnAxis(this.maximum):this.getPixelCoordinatesOnAxis(this._labels[c+1].position),this.ctx.fillRect(a.x,b.y1,Math.abs(d.x-a.x),Math.abs(b.y1-b.y2))}else if(("left"===
this._position||"right"===this._position)&&this.interlacedColor){this.ctx.fillStyle=this.interlacedColor;for(c=0;c<this._labels.length;c+=2)d=this.getPixelCoordinatesOnAxis(this._labels[c].position),a=c+1>=this._labels.length?this.getPixelCoordinatesOnAxis(this.maximum):this.getPixelCoordinatesOnAxis(this._labels[c+1].position),this.ctx.fillRect(b.x1,a.y,Math.abs(b.x1-b.x2),Math.abs(a.y-d.y))}};x.prototype.renderGrid=function(){var a,d=this.chart.getPlotArea();if("bottom"===this._position||"top"===
this._position){if(this.gridThickness&&0<this.gridThickness){this.ctx.lineWidth=this.gridThickness;this.ctx.strokeStyle=this.gridColor;this.ctx.beginPath();for(b=0;b<this._labels.length;b++)this._labels[b].position<this.minimum||this._labels[b].position>this.maximum||(a=this.getPixelCoordinatesOnAxis(this._labels[b].position),this.ctx.moveTo(a.x<<0,d.y1<<0),this.ctx.lineTo(a.x<<0,d.y2<<0),this.ctx.stroke())}}else if(("left"===this._position||"right"===this._position)&&this.gridThickness&&0<this.gridThickness){this.ctx.lineWidth=
this.gridThickness;this.ctx.strokeStyle=this.gridColor;this.ctx.beginPath();for(var b=0;b<this._labels.length;b++)this._labels[b].position<this.minimum||this._labels[b].position>this.maximum||(a=this.getPixelCoordinatesOnAxis(this._labels[b].position),this.ctx.moveTo(d.x1<<0,a.y<<0),this.ctx.lineTo(d.x2<<0,a.y<<0),this.ctx.stroke())}};x.prototype.renderAxisLine=function(){if("bottom"===this._position||"top"===this._position)this.lineThickness&&(this.ctx.lineWidth=this.lineThickness,this.ctx.strokeStyle=
this.lineColor?this.lineColor:"black",this.ctx.beginPath(),this.ctx.moveTo(this.lineCoordinates.x1,this.lineCoordinates.y1),this.ctx.lineTo(this.lineCoordinates.x2,this.lineCoordinates.y2),this.ctx.stroke());else if(("left"===this._position||"right"===this._position)&&this.lineThickness)this.ctx.lineWidth=this.lineThickness,this.ctx.strokeStyle=this.lineColor,this.ctx.beginPath(),this.ctx.moveTo(this.lineCoordinates.x1,this.lineCoordinates.y1),this.ctx.lineTo(this.lineCoordinates.x2,this.lineCoordinates.y2),
this.ctx.stroke()};x.prototype.getPixelCoordinatesOnAxis=function(a){var d={},b=this.lineCoordinates.width,c=this.lineCoordinates.height;if("bottom"===this._position||"top"===this._position)b/=Math.abs(this.maximum-this.minimum),d.x=this.lineCoordinates.x1+b*(a-this.minimum),d.y=this.lineCoordinates.y1;if("left"===this._position||"right"===this._position)b=c/Math.abs(this.maximum-this.minimum),d.y=this.lineCoordinates.y2-b*(a-this.minimum),d.x=this.lineCoordinates.x2;return d};x.prototype.calculateValueToPixelConvertionParameters=
function(){var a={pixelPerUnit:null,minimum:null,reference:null},d=this.lineCoordinates.width,b=this.lineCoordinates.height;a.minimum=this.minimum;if("bottom"===this._position||"top"===this._position)a.pixelPerUnit=d/Math.abs(this.maximum-this.minimum),a.reference=this.lineCoordinates.x1;if("left"===this._position||"right"===this._position)a.pixelPerUnit=-1*b/Math.abs(this.maximum-this.minimum),a.reference=this.lineCoordinates.y2;this.convertionParameters=a};x.prototype.calculateAxisParameters=function(){var a=
this.chart.layoutManager.getFreeSpace();"bottom"===this._position||"top"===this._position?(this.maxWidth=a.width,this.maxHeight=a.height):(this.maxWidth=a.height,this.maxHeight=a.width);var a="axisX"===this.type?500>this.maxWidth?8:Math.max(6,Math.floor(this.maxWidth/62)):Math.floor(this.maxWidth/40),d,b,c,e;"axisX"===this.type?(d=null!==this.sessionVariables.internalMinimum?this.sessionVariables.internalMinimum:this.dataInfo.viewPortMin,b=null!==this.sessionVariables.internalMaximum?this.sessionVariables.internalMaximum:
this.dataInfo.viewPortMax,0===b-d&&(b+=1),c=Infinity!==this.dataInfo.minDiff?this.dataInfo.minDiff:1):"axisY"===this.type&&(d="undefined"===typeof this._options.minimum?this.dataInfo.viewPortMin:this._options.minimum,b="undefined"===typeof this._options.maximum?this.dataInfo.viewPortMax:this._options.maximum,0===b-d?(b+=5,d-=5):(0!==b&&(b+=Math.abs(0.05)),0!==d&&(d-=Math.abs(0.05))),this.includeZero&&"undefined"===typeof this._options.minimum&&0<d&&(d=0),this.includeZero&&"undefined"===typeof this._options.maximum&&
0>b&&(b=0));"axisX"===this.type&&"dateTime"===this.chart.plotInfo.axisXValueType?(e=b-d,this.intervalType||(e/1<=a?(this.interval=1,this.intervalType="millisecond"):e/2<=a?(this.interval=2,this.intervalType="millisecond"):e/5<=a?(this.interval=5,this.intervalType="millisecond"):e/10<=a?(this.interval=10,this.intervalType="millisecond"):e/20<=a?(this.interval=20,this.intervalType="millisecond"):e/50<=a?(this.interval=50,this.intervalType="millisecond"):e/100<=a?(this.interval=100,this.intervalType=
"millisecond"):e/200<=a?(this.interval=200,this.intervalType="millisecond"):e/250<=a?(this.interval=250,this.intervalType="millisecond"):e/300<=a?(this.interval=300,this.intervalType="millisecond"):e/400<=a?(this.interval=400,this.intervalType="millisecond"):e/500<=a?(this.interval=500,this.intervalType="millisecond"):e/(1*y.secondDuration)<=a?(this.interval=1,this.intervalType="second"):e/(2*y.secondDuration)<=a?(this.interval=2,this.intervalType="second"):e/(5*y.secondDuration)<=a?(this.interval=
5,this.intervalType="second"):e/(10*y.secondDuration)<=a?(this.interval=10,this.intervalType="second"):e/(15*y.secondDuration)<=a?(this.interval=15,this.intervalType="second"):e/(20*y.secondDuration)<=a?(this.interval=20,this.intervalType="second"):e/(30*y.secondDuration)<=a?(this.interval=30,this.intervalType="second"):e/(1*y.minuteDuration)<=a?(this.interval=1,this.intervalType="minute"):e/(2*y.minuteDuration)<=a?(this.interval=2,this.intervalType="minute"):e/(5*y.minuteDuration)<=a?(this.interval=
5,this.intervalType="minute"):e/(10*y.minuteDuration)<=a?(this.interval=10,this.intervalType="minute"):e/(15*y.minuteDuration)<=a?(this.interval=15,this.intervalType="minute"):e/(20*y.minuteDuration)<=a?(this.interval=20,this.intervalType="minute"):e/(30*y.minuteDuration)<=a?(this.interval=30,this.intervalType="minute"):e/(1*y.hourDuration)<=a?(this.interval=1,this.intervalType="hour"):e/(2*y.hourDuration)<=a?(this.interval=2,this.intervalType="hour"):e/(3*y.hourDuration)<=a?(this.interval=3,this.intervalType=
"hour"):e/(6*y.hourDuration)<=a?(this.interval=6,this.intervalType="hour"):e/(1*y.dayDuration)<=a?(this.interval=1,this.intervalType="day"):e/(2*y.dayDuration)<=a?(this.interval=2,this.intervalType="day"):e/(4*y.dayDuration)<=a?(this.interval=4,this.intervalType="day"):e/(1*y.weekDuration)<=a?(this.interval=1,this.intervalType="week"):e/(2*y.weekDuration)<=a?(this.interval=2,this.intervalType="week"):e/(3*y.weekDuration)<=a?(this.interval=3,this.intervalType="week"):e/(1*y.monthDuration)<=a?(this.interval=
1,this.intervalType="month"):e/(2*y.monthDuration)<=a?(this.interval=2,this.intervalType="month"):e/(3*y.monthDuration)<=a?(this.interval=3,this.intervalType="month"):e/(6*y.monthDuration)<=a?(this.interval=6,this.intervalType="month"):(this.interval=e/(1*y.yearDuration)<=a?1:e/(2*y.yearDuration)<=a?2:e/(4*y.yearDuration)<=a?4:Math.floor(x.getNiceNumber(e/(a-1),!0)/y.yearDuration),this.intervalType="year")),this.minimum=null!==this.sessionVariables.internalMinimum?this.sessionVariables.internalMinimum:
d-c/2,this.maximum=this.sessionVariables.internalMaximum?this.sessionVariables.internalMaximum:b+c/2,this.valueFormatString||("year"===this.intervalType?this.valueFormatString="YYYY":"month"===this.intervalType?this.valueFormatString="MMM YYYY":"week"===this.intervalType?this.valueFormatString="MMM DD YYYY":"day"===this.intervalType?this.valueFormatString="MMM DD YYYY":"hour"===this.intervalType?this.valueFormatString="hh:mm TT":"minute"===this.intervalType?this.valueFormatString="hh:mm TT":"second"===
this.intervalType?this.valueFormatString="hh:mm:ss TT":"millisecond"===this.intervalType&&(this.valueFormatString="f'ms'")),this.intervalStartPosition=this.getLabelStartPoint(new Date(this.minimum),this.intervalType,this.interval)):(this.intervalType="number",e=x.getNiceNumber(b-d,!1),this.interval=this._options&&this._options.interval?this._options.interval:x.getNiceNumber(e/(a-1),!0),this.minimum=null!==this.sessionVariables.internalMinimum?this.sessionVariables.internalMinimum:Math.floor(d/this.interval)*
this.interval,this.maximum=null!==this.sessionVariables.internalMaximum?this.sessionVariables.internalMaximum:Math.ceil(b/this.interval)*this.interval,"axisX"===this.type?(null===this.sessionVariables.internalMinimum&&(this.minimum=d-c/2),this.sessionVariables.internalMaximum||(this.maximum=b+c/2),this.intervalStartPosition=Math.floor((this.minimum+this.interval)/this.interval)*this.interval):"axisY"===this.type&&(this.intervalStartPosition=this.minimum));"axisX"===this.type&&(this._absoluteMinimum=
this._options&&"undefined"!==typeof this._options.minimum?this._options.minimum:this.dataInfo.min-c/2,this._absoluteMaximum=this._options&&"undefined"!==typeof this._options.maximum?this._options.maximum:this.dataInfo.max+c/2);if(!this.valueFormatString&&(this.valueFormatString="#,##0.##",e=Math.abs(this.maximum-this.minimum),1>e&&(d=Math.floor(Math.abs(Math.log(e)/Math.LN10))+2,2<d)))for(b=0;b<d-2;b++)this.valueFormatString+="#"};x.prototype._getFontString=function(){return this.labelFontStyle+" "+
this.labelFontWeight+" "+this.labelFontSize+"px "+this.labelFontFamily};x.getNiceNumber=function(a,d){var b=Math.floor(Math.log(a)/Math.LN10),c=a/Math.pow(10,b);return(d?1.5>c?1:3>c?2:7>c?5:10:1>=c?1:2>=c?2:5>=c?5:10)*Math.pow(10,b)};x.prototype.getLabelStartPoint=function(){var a=L(this.interval,this.intervalType),a=new Date(Math.floor(this.minimum/a)*a);if("millisecond"!==this.intervalType)if("second"===this.intervalType)0<a.getMilliseconds()&&(a.setSeconds(a.getSeconds()+1),a.setMilliseconds(0));
else if("minute"===this.intervalType){if(0<a.getSeconds()||0<a.getMilliseconds())a.setMinutes(a.getMinutes()+1),a.setSeconds(0),a.setMilliseconds(0)}else if("hour"===this.intervalType){if(0<a.getMinutes()||0<a.getSeconds()||0<a.getMilliseconds())a.setHours(a.getHours()+1),a.setMinutes(0),a.setSeconds(0),a.setMilliseconds(0)}else if("day"===this.intervalType){if(0<a.getHours()||0<a.getMinutes()||0<a.getSeconds()||0<a.getMilliseconds())a.setDate(a.getDate()+1),a.setHours(0),a.setMinutes(0),a.setSeconds(0),
a.setMilliseconds(0)}else if("week"===this.intervalType){if(0<a.getDay()||0<a.getHours()||0<a.getMinutes()||0<a.getSeconds()||0<a.getMilliseconds())a.setDate(a.getDate()+(7-a.getDay())),a.setHours(0),a.setMinutes(0),a.setSeconds(0),a.setMilliseconds(0)}else if("month"===this.intervalType){if(1<a.getDate()||0<a.getHours()||0<a.getMinutes()||0<a.getSeconds()||0<a.getMilliseconds())a.setMonth(a.getMonth()+1),a.setDate(1),a.setHours(0),a.setMinutes(0),a.setSeconds(0),a.setMilliseconds(0)}else if("year"===
...
H.prototype.disableAnimation=function(){this.container.style.WebkitTransition&&(this.container.style.WebkitTransition="",this.container.style.MozTransition="",this.container.style.MsTransition="",this.container.style.transition="")};H.prototype.hide=function(){this.container.style.display="none";this.currentSeriesIndex=-1;this.chart.resetOverlayedCanvas()};t.prototype.replaceKeywordsWithValue=function(a,d,b,c){var e=this;return a.replace(/\{\s*[a-zA-Z]+\s*\}|"[^"]*"|'[^']*'/g,function(a){if('"'===
a[0]&&'"'===a[a.length-1]||"'"===a[0]&&"'"===a[a.length-1])return a.slice(1,a.length-1);a=M(a.slice(1,a.length-1));var g=null;if("color"===a)return d.color?d.color:b.color?b.color:b._colorSet[c%b._colorSet.length];if(d.hasOwnProperty(a))g=d;else if(b.hasOwnProperty(a))g=b;else return"";return"x"===a?e.axisX&&"dateTime"===e.plotInfo.axisXValueType?V(g[a],d.xValueFormatString?d.xValueFormatString:b.xValueFormatString?b.xValueFormatString:e.axisX.valueFormatString?e.axisX.valueFormatString:"DD MM YY"):
W(g[a],d.xValueFormatString?d.xValueFormatString:b.xValueFormatString?b.xValueFormatString:"#,##0.##"):"y"===a?W(g[a],d.xValueFormatString?d.xValueFormatString:b.xValueFormatString?b.xValueFormatString:"#,###.##"):g[a]})};P.prototype.reset=function(){this.lastObjectId=0;this.objectMap=[];this.rectangularRegionEventSubscriptions=[];this.previousDataPointEventObject=null;this.ghostCtx.clearRect(0,0,this.ghostCanvas.width,this.ghostCanvas.height);this.ghostCtx.beginPath()};P.prototype.getNewObjectTrackingId=
function(){return++this.lastObjectId};P.prototype.mouseEventHandler=function(a){if(!("mousemove"!==a.type&&"click"!==a.type)){var d=null,b=null,c=null,e=-1,f=!1,g=!1,k=ba(a),b=this.ghostCtx.getImageData(k.x,k.y,1,1).data;if(240<b[3])if(b=b[0]<<16|b[1]<<8|b[2],"undefined"!==typeof this.objectMap[b]&&"dataPoint"===this.objectMap[b].objectType){d=this.objectMap[b];b=this.chart.data[d.dataSeriesIndex];c=b.dataPoints[d.dataPointIndex];e=d.dataPointIndex;if(null===this.previousDataPointEventObject||this.previousDataPointEventObject.dataSeriesIndex!==
d.dataSeriesIndex||this.previousDataPointEventObject.dataPointIndex!==d.dataPointIndex)if(this.previousDataPointEventObject&&(f=!0),c.mouseover&&c.mouseover.call(c,{x:k.x,y:k.y,dataPoint:c,dataSeries:b,dataPointIndex:e}),b.mouseover&&(null===this.previousDataPointEventObject||this.previousDataPointEventObject.dataSeriesIndex!==d.dataSeriesIndex))b.mouseover&&b.mouseover.call(b,{x:k.x,y:k.y,dataPoint:c,dataSeries:b,dataPointIndex:e}),this.previousDataPointEventObject&&(g=!0);"mousemove"===a.type?(c.mousemove&&
c.mousemove.call(c,{x:k.x,y:k.y,dataPoint:c,dataSeries:b,dataPointIndex:e}),b.mousemove&&b.mousemove.call(b,{x:k.x,y:k.y,dataPoint:c,dataSeries:b,dataPointIndex:e})):"click"===a.type&&(c.click&&c.click.call(c,{x:k.x,y:k.y,dataPoint:c,dataSeries:b,dataPointIndex:e}),b.click&&b.click.call(b,{x:k.x,y:k.y,dataPoint:c,dataSeries:b,dataPointIndex:e}),this.chart.pieDoughnutClickHandler&&this.chart.pieDoughnutClickHandler.call(b,{x:k.x,y:k.y,dataPoint:c,dataSeries:b,dataPointIndex:e}))}else this.previousDataPointEventObject&&
(g=f=!0);else this.previousDataPointEventObject&&(g=f=!0);if(f||g)a=this.chart.data[this.previousDataPointEventObject.dataSeriesIndex],b=a.dataPoints[this.previousDataPointEventObject.dataPointIndex],c=this.previousDataPointEventObject.dataPointIndex,f&&b.mouseout&&b.mouseout.call(b,{x:k.x,y:k.y,dataPoint:b,dataSeries:a,dataPointIndex:c}),g&&a.mouseout&&a.mouseout.call(a,{x:k.x,y:k.y,dataPoint:b,dataSeries:a,dataPointIndex:c});this.previousDataPointEventObject=d}};var G={drawMarker:function(a,d,b,
c,e,f,g,k){if(b){var h=1;b.fillStyle=f?f:"#000000";b.strokeStyle=g?g:"#000000";b.lineWidth=k?k:0;"circle"===c?(b.beginPath(),b.arc(a,d,e/2,0,360,!1),f&&b.fill(),k&&(g?b.stroke():(h=b.globalAlpha,b.globalAlpha=0.15,b.strokeStyle="black",b.stroke(),b.globalAlpha=h))):"square"===c?(b.beginPath(),b.rect(a-e/2,d-e/2,e,e),f&&b.fill(),k&&(g?b.stroke():(h=b.globalAlpha,b.globalAlpha=0.15,b.strokeStyle="black",b.stroke(),b.globalAlpha=h))):"triangle"===c?(b.beginPath(),b.moveTo(a-e/2,d+e/2),b.lineTo(a+e/2,
d+e/2),b.lineTo(a,d-e/2),b.closePath(),f&&b.fill(),k&&(g?b.stroke():(h=b.globalAlpha,b.globalAlpha=0.15,b.strokeStyle="black",b.stroke(),b.globalAlpha=h))):"cross"===c&&(b.strokeStyle=f,b.lineWidth=e/4,b.beginPath(),b.moveTo(a-e/2,d-e/2),b.lineTo(a+e/2,d+e/2),b.stroke(),b.moveTo(a+e/2,d-e/2),b.lineTo(a-e/2,d+e/2),b.stroke())}},drawMarkers:function(a){for(var d=0;d<a.length;d++){var b=a[d];G.drawMarker(b.x,b.y,b.ctx,b.type,b.size,b.color,b.borderColor,b.borderThickness)}}},O={Chart:function(a,d){var b=
new t(a,d,this);this.render=function(){b.render()};this.options=b._options}};O.Chart.version="1.0.0 Beta";window.CanvasJS=O})();
